...
exports.getCurrentRide =
  exports.getOngoingRide =
  exports.getPendingRideByCaptain =
  exports.getPendingRideByUser =
  exports.createRide =
    void 0;
...
const calculateFare = ({
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to fetch distance and time: ${response.status}`
        );
      }
...
const createRide = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (!rideData.success || !req.user) {
      res
        .status(400)
        .send(
          new ApiError_1.default(400, "Credentails are wrong", rideData.error)
        );
      return;
    }
    const {
    ...
    const rideCreate = yield ride_models_1.default.create({
      user:
        (_a = req.user._id) === null || _a === void 0 ? void 0 : _a.toString(),
      vehicleType: vehicle,
      pickupLocation,
      destinationLocation,
      fare,
    ...
    res.send(
      new ApiResponse_1.default(
        200,
        rideCreate,
        "Successfully craeted the Ride"
      )
    );
  })
);
exports.createRide = createRide;
const getPendingRideByUser = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const userId =
      (_b = req.user._id) === null || _b === void 0 ? void 0 : _b.toString();
    console.log(userId);
    ...
    res
      .status(200)
      .send(
        new ApiResponse_1.default(200, getRide, "Successfully Get the Ride")
      );
  })
);
exports.getPendingRideByUser = getPendingRideByUser;
const getOngoingRide = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!rideId) {
      res
        .status(400)
        .send(
          new ApiError_1.default(400, "Error while getting the rideId", rideId)
        );
    }
    ...
    if (!getRide) {
      res
        .status(400)
        .send(
          new ApiError_1.default(400, "Error while getting the Ride", getRide)
        );
    }
    res.send(
      new ApiResponse_1.default(200, getRide, "Successfully Get the Ride")
...
const getPendingRideByCaptain = (0, asyncHandler_1.default)((_, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const getRide = yield ride_models_1.default.find({
      status: "pending",
    });
...
const getCurrentRide = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { rideId } = req.query;
    const getRide = yield ride_models_1.default.findById(rideId);
    console.log(getRide);
