...
exports.getCurrentRide = exports.getOngoingRide = exports.getPendingRideByCaptain = exports.getPendingRideByUser = exports.createRide = void 0;
...
const getCurrentRide = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { rideId } = req.query;
    const getRide = yield ride_models_1.default.findById(rideId);
    res.send(new ApiResponse_1.default(200, getRide, "Successfully Get the Ride"));
}));
