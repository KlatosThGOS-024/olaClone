...
exports.userProfileFromCaptain =
  exports.captainProfile =
  exports.captainLogout =
  exports.captainLogin =
  exports.captainCreate =
    void 0;
...
const captainProfile = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    res
      ...
      .send(
        new ApiResponse_1.default(
          200,
          captain,
          "User Profile Successfully retrevied"
        )
      );
  })
);
exports.captainProfile = captainProfile;
const userProfileFromCaptain = (0, asyncHandler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.body;
    const userProfile = yield user_models_1.default
      .findById({ userId })
      .select("-password");
    res
      .status(200)
