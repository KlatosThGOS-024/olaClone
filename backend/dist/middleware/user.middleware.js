  ...
  (() =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        console.log(userId);
        const user = yield user_models_1.default
          .findById(userId)
          .select("-password");
        if (!user) {
          return next(
            new ApiError_1.default(400, "No User Found with this token.")
          );
        }
        req.user = user;
        next();
        ...
        next(
          new ApiError_1.default(400, "Un-Authorized Access", [], error.error)
        );
      }
    }))();
};
  ...
  (() =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        const captain = yield captain_models_1.default
          .findById(captainId)
          .select("-password");
        if (!captain) {
          return next(
